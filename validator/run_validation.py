...
from validator.database_validator import run_db_regression
from validator.clinical_validator import run_clinical_regression
...
def main():
    ...
    db_results = run_db_regression(DB_DIR)
