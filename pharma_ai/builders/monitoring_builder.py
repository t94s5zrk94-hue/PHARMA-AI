...
from pharma_ai.builders.id_generator import get_next_monitoring_id


class MonitoringBuilder(BaseBuilder):
    """
    Phase 15.9
    Monitoring Parameters Builder
    """
    ...
    def __init__(self):
        ...
        self.input_file = Path(
            "pharma_ai/database/input/monitoring_input.csv"
        )
        ...
        self.logger.info("MonitoringBuilder initialized.")

    def _load_input(self):

        self.logger.info("Loading monitoring input...")
    ...
    def _validate_duplicates(self):
        ...
        self.logger.info(
            "Checking duplicate monitoring records..."
        )
        ...
        if duplicate_mask.any():
            ...
            raise ValueError(
                f"Duplicate monitoring records found:\n{duplicates}"
            )
    ...
    def _generate_ids(self):
        ...
        self.logger.info("Generating Monitoring IDs...")
        ...
        if not self.master_df.empty:
            last_id = self.master_df.iloc[-1]["Monitoring_ID"]

        self.df.insert(
            0,
            "Monitoring_ID",
            get_next_monitoring_id(
                last_id=last_id,
                count=len(self.df),
            ),
        )
        ...
        self.logger.info(
            "Monitoring IDs generated successfully."
        )
    ...
    def _merge_master(self):
        ...
        self.logger.info(
            "Monitoring master saved successfully (%d records).",
            len(final_df),
        )
    ...
    def build(self):
        ...
        self.logger.info(
            "Monitoring Builder completed successfully."
        )
    ...
    def main():
        ...
        builder = MonitoringBuilder()
        builder.build()


if __name__ == "__main__":
    MonitoringBuilder.main()    