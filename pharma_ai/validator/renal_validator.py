...
class RenalValidator:
    """
    Phase 15.7
    Renal Dose Adjustment Validator
    """
    ...
    def load_master(self):
        ...
        self.logger.info("Loading Renal Master...")
    ...
    def validate_duplicate_ids(self):
        ...
        duplicates = self.df["Renal_ID"].duplicated().sum()

        self.statistics["duplicate_ids"] = int(duplicates)

        if duplicates > 0:
            raise ValueError(
                f"Duplicate Renal_ID found: {duplicates}"
            )

        self.logger.info(
            "Renal_ID validation passed."
        )
    ...
    def validate_duplicate_pairs(self):
        ...
        if duplicates > 0:
            raise ValueError(
                f"Duplicate Renal pair found: {duplicates}"
            )

        self.logger.info(
            "Renal pair validation passed."
        )
    ...
    def calculate_health_score(self):
        ...
        self.logger.info("")
        self.logger.info("Health Score: %d/100", score)
